...
const Signup = {
              ...
              <div class="hidden md:block w-1/2 bg-indigo-500 py-10 px-10">
                 <svg id="a87032b8-5b37-4b7e-a4d9-4dbfbe394641" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path id="bfd7963f-0cf8-4885-9d3a-2c00bccda2e3" data-name="Path 102"
                       ...
                       transform="translate(-227.576 -76.46149)" fill="#2f2e41" /></svg>
              </div>
                 ...
                 <form id="form-signup">
                    <div class="flex -mx-3">
                       <div class="w-full px-3 mb-5">
                          <label for="" class="text-xs font-semibold px-1">Tên đăng nhập</label>
                          <div class="flex">
                             <div
                    ...
                    <div class="flex -mx-3">
                       <div class="w-full px-3 mb-5">
                          <label for="" class="text-xs font-semibold px-1">Số điện thoại</label>
                          <div class="flex">
                             <div
                                class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                <i class="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                             <input type="number"
                                class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                placeholder="012 345 678" id="phone">
                          </div>
                       </div>
                    </div>
                    <div class="flex -mx-3">
    ...
    afterLogin() {
        const fromSignup = document.querySelector("#form-signup");
        fromSignup.addEventListener("submit", async (e) => {
            e.preventDefault();
