...
const Popup = {
    render() {
        return /* html */`<div style="opacity: -0.1; display: none;"
        class="py-12 fixed  inset-0 overflow-y-auto bg-gray-700 transition z-30 max-h-full overflow-hidden  duration-150 ease-in-out  top-0 right-0 bottom-0 left-0"
        id="popup-product">
