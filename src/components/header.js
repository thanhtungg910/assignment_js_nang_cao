...
const Header = {
    render() {
      ...
      <header class="relative">
            <div id="menu" class="fixed top-0 left-0 right-0 text-white  py-1 hover:bg-white hover:text-black  z-50">
            <div class="flex justify-around items-center header-top">
            <svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" class="w-36 h-7 text-white"  viewBox="0 0 170.445 21.625">
